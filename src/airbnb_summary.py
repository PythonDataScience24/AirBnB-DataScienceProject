...
class AirBnBSummary:
    ...
    def clean_data(self) -> pd.DataFrame:
        ...
        self.df.loc[self.df["neighbourhood_group"] == "manhatan", "neighbourhood group"] = "Manhattan"
        self.df.loc[self.df["neighbourhood_group"] == "brookln", "neighbourhood group"] = "Brooklyn"
        return self.df
